...
export const QuestionsPanel = (props: QuestionsPanelProps): JSX.Element => {
  ...
  function handleChange(
    ...
    switch (data.name) {
      case "knowsBlek":
        setKnowsBlek(data.value as number);
        break;
      case "knowsEdge":
        setKnowsEdge(data.value as number);
        break;
      case "knowsUnpossible":
        setKnowsUnpossible(data.value as number);
        break;
      case "videogameExpertise":
        setVideogameExpertise(data.value as number);
        break;
    }
  }

  function handleHoursPerWeekChange(
      ...
      <div style={{ margin: "auto", width: "57.5%", minWidth: "800px" }}>
        <Grid celled centered columns={1}>
          <Grid.Row>
            <Grid.Column>
              <label>
                ¿Podrías por favor, decirme a lo largo del último año cuántas
                horas a la semana juegas a videojuegos?:
              </label>
              <p></p>
              <Form.Group inline>
          ...
          <Grid.Row>
            <Button attached="bottom" onClick={sendForm} color="blue">
              Enviar
            </Button>
          </Grid.Row>
        </Grid>
